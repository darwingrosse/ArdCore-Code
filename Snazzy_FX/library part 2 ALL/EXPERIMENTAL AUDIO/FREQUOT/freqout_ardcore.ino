...
/*  freqoutfreqout(freq, t)  // freq in hz, t in ms
*   Paul Badger 2007    <Modified with additions for realtime/ CV control)
*   by Dan Snazelle 2012
